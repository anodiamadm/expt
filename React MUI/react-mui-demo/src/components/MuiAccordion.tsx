    ...
    return (
        <Box width='400px'>
            <Accordion expanded={expanded === 'panel1'} onChange={(event, isExpanded) => handleChange(isExpanded, 'panel1')}>
                ...
                <AccordionDetails>
                    <Typography>Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse quibusdam dicta obcaecati rerum ex consequuntur, incidunt ipsum sapiente consectetur voluptas exercitationem illum repellendus adipisci distinctio eligendi vero labore. Reprehenderit, repellat.</Typography>
                </AccordionDetails>
            </Accordion>
